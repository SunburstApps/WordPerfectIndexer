...
WP6AttributeGroup::WP6AttributeGroup(librevenge::RVNGInputStream *input, WPXEncryption *encryption, unsigned char groupID) :
...
WP6AttributeOnGroup::WP6AttributeOnGroup(librevenge::RVNGInputStream *input, WPXEncryption *encryption, unsigned char groupID)
...
WP6AttributeOffGroup::WP6AttributeOffGroup(librevenge::RVNGInputStream *input, WPXEncryption *encryption, unsigned char groupID)
	: WP6AttributeGroup(input, encryption, groupID)
{
}
