 ...
 *
 * Major Contributor(s):
 * Copyright (C) 2007Fridrich Strba (fridrich.strba@bluewin.ch)
 *
...
#ifndef WP1FONTIDGROUP_H
#define WP1FONTIDGROUP_H
...
private:
	unsigned short m_oldFontId, m_newFontId;
};

#endif /* WP1FONTIDGROUP_H */
